...
def main():
    ...
    dep_check = run_command([sys.executable, "check_dependencies.py"], "Dependency check")
    if not dep_check:
    ...
    build_success = run_command([sys.executable, "build_scripts/build.py"], "Application build")
    ...
    if args.installer:
        ...
        installer_success = run_command([sys.executable, "installer/build_installer.py"], "Installer build")
